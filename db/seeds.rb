...
post1.photo.attach(io: File.open('/Users/christinema/Desktop/image/image0.jpg'), filename: "image0.jpg")
post2 = Post.create!({body:'summer body ready', user_id: frances.id })
post2.photo.attach(io: File.open('/Users/christinema/Desktop/image/image1.jpg'), filename: "image1.jpg")
post3 = Post.create!({body:'Crossfit Regional2018', user_id: erin.id })
post3.photo.attach(io: File.open('/Users/christinema/Desktop/image/image2.jpg'), filename: "image2.jpg")
...
post4.photo.attach(io: File.open('/Users/christinema/Desktop/image/image3.jpg'), filename: "image3.jpg")
post5 = Post.create!({body:'take me back to here', user_id: yvet.id})
post5.photo.attach(io: File.open('/Users/christinema/Desktop/image/image4.jpg'), filename: "image4.jpg")
post6 = Post.create!({body:'babiessss',user_id: steve.id })
post6.photo.attach(io: File.open('/Users/christinema/Desktop/image/image5.jpg'), filename: "image5.jpg")
post7 = Post.create!({body:'vacation mode on!',user_id: erinc.id })
post7.photo.attach(io: File.open('/Users/christinema/Desktop/image/image6.jpg'), filename: "image6.jpg")
post8 = Post.create!({body:'whos a good girl?',user_id: steph.id })
post8.photo.attach(io: File.open('/Users/christinema/Desktop/image/image7.jpg'), filename: "image7.jpg")
post9 = Post.create!({body:'Summer 2018',user_id: beka.id })
post9.photo.attach(io: File.open('/Users/christinema/Desktop/image/image8.jpg'), filename: "image8.jpg")
post10 = Post.create!({body:'Bruano Island, Italy',user_id: erin.id})
post10.photo.attach(io: File.open('/Users/christinema/Desktop/image/image9.jpg'), filename: "image9.jpg")
post11 = Post.create!({body:'breakfast with a view', user_id: angela.id })
post11.photo.attach(io: File.open('/Users/christinema/Desktop/image/image10.jpg'), filename: "image10.jpg")
